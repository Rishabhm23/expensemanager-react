...
const Filter = () => {
    ...
    const handleSearch = async (e) => {
        ...
        try{
            ...
            console.log("Somme error occured while filtering");
            toast.error(error.response?.data?.message || "Somme error occured while filtering");
        }finally{
            setLoading(false);
        }
    }
                ...
                <div className="my-5 mx-auto">
                        ...
                        <form className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-6 gap-4">
                            ...
                            <div className="sm:col-span-1 md:col-span-1 flex items-end">
                                <div className="w-full">
                                    ...
                                    <input value={keyword} id="keyword" type="text" placeholder="Search..." className="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent" onChange={e => setKeyword(e.target.value)}/>
                                </div>
                                <button onClick={handleSearch} className="ml-2 p-2 bg-purple-800 hover:bg-purple-900 text-white rounded flex items-center justify-center cursor-pointer transition-colors">
                                    <Search />
                                </button>
                            </div>
                    ...
                    <div className="card p-4">
                        ...
                        {transactions.length === 0 && !loading? (
                            <p className="text-gray-800">Select the filters and click apply to filter the transactions</p>
                        ) : ""}
                        {loading ? (
