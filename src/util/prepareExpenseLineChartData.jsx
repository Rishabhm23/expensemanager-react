...
export const prepareExpenseLineChartData = (transactions) => {
  ...
  transactions.forEach((transaction) => {
    ...
    dailyExpense[dateKey].amount += parseFloat(transaction.amount);
    dailyExpense[dateKey].count += 1;
  });

  // Convert to array and sort by date
  const chartData = Object.entries(dailyExpense)
